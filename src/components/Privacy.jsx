...
const Privacy = () => {
    return (
        <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h1 className="rounded-md about-title text-4xl text-center italic font-bold p-2 mb-8 mt-[100px] bg-gradient-to-r from-sky-500">Privacy Policy</h1>
                    <p className=" mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                ...
                <div>
                    ...
                    <ul className="list-disc list-inside mb-4 ">
                        ...
                        <li>Information we get from your use of our services. We collect information about the services that you use and how you use them, like when you visit a website that uses our services or you view and interact with our ads and content.</li>
                    </ul>
    ...
    <p className="mb-4">
        We are committed to safeguarding your personal information and ensuring transparency about how it is shared. Below, we outline our key information sharing practices:
    </p>
    <ul className="list-disc list-inside mb-4">
        <li>
            <strong>Third-Party Service Providers:</strong> We may share your data with vendors or contractors who assist in our operations, such as payment processors, email services, and customer support.
        </li>
        <li>
        ...
        <li>
            <strong>Children's Privacy:</strong> We take special care in handling data collected from children under a certain age, complying with laws like COPPA.
        </li>
        <li>
            <strong>Policy Updates:</strong> We will inform you about any updates to our privacy policy and the effective date of such changes.
        </li>
    </ul>
</div>
